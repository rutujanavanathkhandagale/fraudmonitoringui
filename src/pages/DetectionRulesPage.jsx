...
import { getAllDetectionRules, deleteDetectionRule } from "../services/detectionRuleService";
import DetectionRuleList from "../components/DetectionRuleList";
import DetectionRuleForm from "../components/DetectionRuleForm";
import DetectionRuleEditForm from "../components/DetectionRuleEditForm";
      ...
      <div className="glass-panel p-3 mb-4">
        <div className="d-flex gap-3 flex-wrap">
          <input
            ...
            placeholder="Search by scenario, risk domain..."
            value={searchTerm}
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content bg-dark border-secondary shadow-lg">
              <div className="modal-header border-0">
                ...
                <button type="button" className="btn-close btn-close-white" onClick={() => setShowCreateForm(false)}></button>
              </div>
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content bg-dark border-secondary shadow-lg">
              <div className="modal-header border-0">
                ...
                <button type="button" className="btn-close btn-close-white" onClick={() => setEditingRule(null)}></button>
              </div>
              <div className="modal-body">
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content bg-dark border-secondary">
              <div className="modal-header border-0">
                ...
                <button type="button" className="btn-close btn-close-white" onClick={() => setDeletingRule(null)}></button>
              </div>
