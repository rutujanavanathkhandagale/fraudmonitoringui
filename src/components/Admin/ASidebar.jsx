...
<MenuItem icon={<FiList />} text="Role" path="/role" collapsed={collapsed} />
<MenuItem icon={<FiShield />} text="System Users" path="/users" collapsed={collapsed} />
<MenuItem icon={<FiFileText />} text="Audit Logs" path="/audit" collapsed={collapsed} />
{/* <MenuItem icon={<FiBell />} text="Alerts" path="/alerts" collapsed={collapsed} />
      <MenuItem icon={<FiBarChart2 />} text="Analytics" path="/analytics" collapsed={collapsed} />
      <MenuItem icon={<FiFileText />} text="Reports" path="/reports" collapsed={collapsed} /> */ }
    </div> 
  );
}
