    ...
    <form onSubmit={handleSubmit} className="text-white">
      ...
      <div className="mb-3">
        ...
        <input
          ...
          className={`form-control bg-dark text-white ${
            errors.expression ? "is-invalid" : "border-secondary"
          }`}
      ...
      <div className="row">
        <div className="col-md-6 mb-3">
          ...
          <input
            ...
            name="threshold"
            className={`form-control bg-dark text-white ${
              errors.threshold ? "is-invalid" : "border-secondary"
            }`}
            value={formData.threshold}
            onChange={handleChange}
          />
          {errors.threshold && (
            <div className="invalid-feedback text-danger small">{errors.threshold}</div>
          )}
        </div>
        <div className="col-md-6 mb-3">
          <label className="form-label">
          ...
          <input
            ...
            name="version"
            className={`form-control bg-dark text-white ${
              errors.version ? "is-invalid" : "border-secondary"
            }`}
      ...
      <div className="mb-3">
        ...
        <input
          ...
          name="customerType"
          className={`form-control bg-dark text-white ${
            errors.customerType ? "is-invalid" : "border-secondary"
          }`}
      ...
      <div className="mb-4">
        ...
        <select
          ...
          onChange={handleChange}
        >
          <option value="Active" style={{ color: "#fff", backgroundColor: "#1a0b2e" }}>
            Active
          </option>
          <option value="Inactive" style={{ color: "#fff", backgroundColor: "#1a0b2e" }}>
            Inactive
          </option>
        </select>
      </div>
